...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        // Livrable 1
        var product = products.Select(product => new
        {
        ...
        //// Livrable 2
        //string csvFilePath = "C:\\Users\\po01imj\\Documents\\GitHub\\323-Programmation_fonctionnelle\\personnel\\semaine3\\Exo_Marche\\product.csv";

        //using (StreamWriter writer = new StreamWriter(csvFilePath))
        //{
        //    writer.WriteLine("Seller,Product,Age");
        ...
        //int amount = product.Aggregate(product.GroupBy((p => p.Product == "Berries"), ))

        int amount = products.Where(p => p.ProductName == "Groseilles").Sum(p => p.Quantity);
        Console.WriteLine($"Total Groseilles: {amount}");
